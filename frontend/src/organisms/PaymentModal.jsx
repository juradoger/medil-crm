...
export function PaymentModal({ isOpen, onClose, appointmentId, amount, branchId, onPaymentSuccess }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 medil-modal-overlay">
      <div className="medil-modal bg-white rounded-2xl p-6 w-full max-w-md">
